    ...
    def __init__(self, # pylint: disable=too-many-locals, too-many-arguments, super-init-not-called
        ...
        if num_samples > 0 and num_samples < self.target_vocab_size:
            ...
            def sampled_loss(labels, logits):
                ...
                return tf.cast(
                    tf.nn.sampled_softmax_loss(local_w_t, local_b, labels,local_inputs,                             num_samples, self.target_vocab_size),dtype)
        ...
        if num_layers > 1:
            cell_tmp = tf.contrib.rnn.MultiRNNCell([single_cell() for _ in range(num_layers)])
